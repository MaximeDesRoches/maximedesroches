...
function getBundler(cnf, isDev){
	var bundler = browserify(JSCONF.src + cnf.src, { debug: true }).transform(babelify, { presets: ["es2015"], plugins: ["transform-class-properties", "transform-object-rest-spread"] });
